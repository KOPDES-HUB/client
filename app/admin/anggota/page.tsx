...
const members: AnggotaMember[] = [
  {
    ...
    alamat: "Jl. Merdeka No. 10, RT 02/RW 05, Kelurahan Sukamaju, Kecamatan Bogor Tengah, Kabupaten Bogor",
  ...
  },
  {
    ...
    nomorKta: "—",
    koperasi: "Koperasi Desa Merah Putih Sukamaju",
    alamat: "Jl. Melati No. 5, RT 01/RW 03, Kelurahan Sukamaju, Kecamatan Bogor Tengah, Kabupaten Bogor",
  ...
  },
  {
    ...
    status: "Aktif",
    joined: "22 Jan 2024",
    nomorKta: "4802 8812 0092 1105",
    koperasi: "Koperasi Desa Merah Putih Sukamaju",
    alamat: "Jl. Kenanga No. 12, RT 03/RW 02, Kelurahan Sukamaju, Kecamatan Bogor Tengah, Kabupaten Bogor",
    jenisKelamin: "Laki-laki",
    pekerjaan: "Guru",
    berlakuHingga: "31 Des 2026",
    totalSimpanan: "Rp 1.800.000",
    jenisKeanggotaan: "Anggota Biasa",
  },
  {
    id: "SMP-2024-004",
    ...
    nomorKta: "—",
    koperasi: "Koperasi Desa Merah Putih Sukamaju",
    alamat: "Jl. Anggrek No. 8, RT 04/RW 01, Kelurahan Sukamaju, Kecamatan Bogor Tengah, Kabupaten Bogor",
    jenisKelamin: "Perempuan",
  ...
  },
  {
    ...
    status: "Nonaktif",
    joined: "28 Jan 2024",
    nomorKta: "4802 8812 0092 1106",
    koperasi: "Koperasi Desa Merah Putih Sukamaju",
    alamat: "Jl. Mawar No. 3, RT 02/RW 04, Kelurahan Sukamaju, Kecamatan Bogor Tengah, Kabupaten Bogor",
    jenisKelamin: "Laki-laki",
    pekerjaan: "Wiraswasta",
    berlakuHingga: "31 Des 2025",
    totalSimpanan: "Rp 500.000",
    jenisKeanggotaan: "Anggota Biasa",
  },
  {
    id: "SMP-2024-006",
    ...
    status: "Aktif",
    joined: "1 Feb 2024",
    nomorKta: "4802 8812 0092 1107",
    koperasi: "Koperasi Desa Merah Putih Sukamaju",
    alamat: "Jl. Dahlia No. 15, RT 05/RW 02, Kelurahan Sukamaju, Kecamatan Bogor Tengah, Kabupaten Bogor",
    jenisKelamin: "Perempuan",
    pekerjaan: "Perawat",
    berlakuHingga: "31 Des 2026",
    totalSimpanan: "Rp 2.100.000",
    jenisKeanggotaan: "Anggota Biasa",
  },
  {
    id: "SMP-2024-007",
    ...
    hp: "0812-3456-0007",
    email: "dani.pradana@email.com",
    status: "Pending",
    joined: "5 Feb 2024",
    nomorKta: "—",
    koperasi: "Koperasi Desa Merah Putih Sukamaju",
    alamat: "Jl. Flamboyan No. 7, RT 01/RW 05, Kelurahan Sukamaju, Kecamatan Bogor Tengah, Kabupaten Bogor",
    jenisKelamin: "Laki-laki",
    pekerjaan: "Sopir",
    berlakuHingga: "—",
    totalSimpanan: "Rp 0",
...
export default function AdminAnggotaPage() {
  ...
  const [selectedMember, setSelectedMember] = useState<AnggotaMember | null>(null);
  ...
  return (
    <>
            ...
            <table className="w-full border-collapse">
              <thead>
                <tr className="bg-surface-bg text-on-surface-variant">
                  <th className="px-6 py-4 text-left text-label-sm font-label-sm uppercase tracking-wider">
                    Anggota
                  </th>
                  <th className="px-6 py-4 text-left text-label-sm font-label-sm uppercase tracking-wider">
                    ID / NIK
                  ...
                  <th className="px-6 py-4 text-center text-label-sm font-label-sm uppercase tracking-wider">
                    Status
                  </th>
                  <th className="px-6 py-4 text-center text-label-sm font-label-sm uppercase tracking-wider">
                    Aksi
                ...
                {filtered.map((member) => (
                  <tr key={member.id} className="hover:bg-surface-bg transition-colors">
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          {member.status === "Aktif" && (
                            <p className="text-label-xs font-label-xs text-on-surface-variant font-mono">
                              KTA: {member.nomorKta}
                            </p>
                          )}
                        </div>
                    ...
                    <td className="px-6 py-4 text-center">
                      <span
                        className={`px-3 py-1 rounded-full text-label-xs font-label-xs ${statusColors[member.status]}`}
                      >
                        {member.status}
                      </span>
                    </td>
      ...
      <AnggotaDetailModal member={selectedMember} onClose={() => setSelectedMember(null)} />
    </>
  );
}
