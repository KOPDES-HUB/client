...
export default function TopBar({ title, breadcrumb, showSearch = true }: TopBarProps) {
  return (
        ...
        {showSearch && (
          <div className="relative hidden md:flex items-center">
            ...
            <input
              type="text"
              placeholder="Cari..."
              className="pl-10 pr-4 py-2 rounded-lg border border-outline-variant/50 bg-surface-bg text-body-md text-on-surface placeholder:text-on-surface-variant/50 focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary w-56 transition-all"
            />
          </div>
        )}
